# Zadania malych uloh na precvicenie jazyka Python

Tieto ulohy su prebrate a ciastocne upravene. Povodny zdroj uloh je tu: https://github.com/PabloVallejo/python-exercises

Zadania povodnych uloh su v anglickom jazyku. verim, ze nikomu tento jazyk nebude robit problemy a preto aj tieto ulohy necham v tomto jazyku.

Cielom tychto uloh nie je prechadzat si rozne koncepty z analyzy dat. Toto su len ulohy na uvod predmetu, ktorych cielom je oboznamit sa alebo si osviezit zakladne koncepty jazyka Python. Sluzia ako stavebny blok pre dalsie cvicenia. 

Ulohy su zhrnute v troch suboroch:
* exercises.md - tento subor, v ktorom su zadania uloh
* exercises.py - predpripravene prazdne tela funkcii, ktore treba doplnit. Klucove slovo `pass` treba nahradit telom funkcie
* tests.py - testy, ktore je mozne pouzit na otestovanie ci implementovana funkcia splna najzakladnejsie poziadavky
...
For example output for array consisting words 'one', 'two', 'three', 'four' should be [3, 3, 5, 4]
...
## Ulohy na precvicenie roznych funkcionalnych crt jazyka Python
