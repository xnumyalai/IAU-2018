...
# Testy pre ulohy
#
# Poznamka: Niektore testy su zakomentovane.
# Toto su testy na funkcie, ktore vyzaduju vstup od pouzivatela alebo vysledok pisu na standardny vystup.
# Pre zachovanie jednoduchosti su tieto preskocene.
#
# Pre spustenie testov je potrebne spustit tento subor pomocou interpretera jazyka Python. Pouzivajte interpreter verzie 3.5 a novsi
# Priklad spustenia:
#
#   $ python tests.py
#
